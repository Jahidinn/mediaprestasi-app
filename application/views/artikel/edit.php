		...
		<div class="row">
			<div class="col-md-8">
				...
				<form method="post" action="" enctype="multipart/form-data">
					...
					<input type="hidden" name="deleteimage" value="<?= $editArtikel['image'];  ?>">

					<div class="form-group">
						<label for="kategori-artikel">Kategori rtikel</label>
						<input type="text" class="form-control" name="kategori-artikel" id="kategori-artikel" value="<?= $editArtikel['kategori-artikel'];?>" placeholder="ex : Pendidikan" />
						<small class="form-text text-danger"><?= form_error('kategori-artikel'); ?><?= $this->session->flashdata('flash_error_usr'); ?></small>
					</div>
					<div class="form-group">
						<label for="judul">Judul</label>
						<input type="text" class="form-control" name="judul" id="judul" value="<?= $editArtikel['judul'];?>" placeholder="ex : lomba esai nasional" />
					...
					<div class="form-group">
						...
						<div class="editfoto mb-2">
							<img src="<?=base_url(); ?>assets/img/artikel-image/<?= $editArtikel['image']; ?>" style="width: 200px;">
						</div>
					...
					<div class="form-group">
						...
						<textarea class="form-control ckeditor" name="isi" id="isi" rows="14"><?= $editArtikel['article'];?></textarea>
						<small class="form-text text-danger"><?= form_error('isi'); ?><?= $this->session->flashdata('flash_error_pas'); ?></small>
					</div>

					<div class="form-group">
						<label for="keywords">Keywords</label>
						<input type="text" class="form-control" name="keywords" id="keywords" value="<?= $editArtikel['keywords'];?>" placeholder="ex : Tutorial, beasiswa, travelling" />
